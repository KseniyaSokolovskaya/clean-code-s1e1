...
var incompleteTaskHolder = document.getElementById("todo-list-tasks"); //ul of #todo-list-tasks
var completedTasksHolder = document.getElementById("completed-list-tasks"); //completed-list-tasks
...
var createNewTaskElement = function (taskString) {
  ...
  editInput.type = "text";
  editInput.classList.add("task", "task__text");
...
var taskCompleted = function () {
  ...
  //Append the task list item to the #completed-list-tasks
  var listItem = this.parentNode;
...
var taskIncomplete = function () {
  ...
  //Append the task list item to the #todo-list-tasks.
  var listItem = this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
